...
--
-- Host: localhost
-- Generation Time: Aug 19, 2015 at 05:51 PM
...
INSERT INTO `user_courses` (`userID`, `courseID`, `completion`, `description`, `grading`, `mandatory`, `enrolled`) VALUES
(2, 1, '20.00', '', '80', 1, 1),
(2, 2, '0.00', 'Not started.', '0', 1, 1),
(2, 3, '100.00', '', '90', 0, 1),
(3, 1, '65.00', 'Testing 1', '100', 1, 0),
(3, 2, '10.00', 'Does nothing', '10', 1, 0);
