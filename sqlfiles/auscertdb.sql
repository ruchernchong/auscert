...
INSERT INTO `questions` (`questionID`, `courseID`, `questionOrder`, `passPercentage`, `questionText`, `options`, `answer`) VALUES
(0, 2, 0, 50, '<p>Which of these is a safe password?</p>\r\n', '', 0),
(0, 11, 0, 50, '<p>Who is the project manager for &quot;Old School&quot;</p>\r\n', '', 0);
