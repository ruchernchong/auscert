                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <a class="btn btn-success" id="add_user_btn"><i class="fa fa-caret-left"></i>&emsp;Add User&emsp;&emsp;</a>
                            </div>
                            <div class="form-group">
                                <a class="btn btn-danger" id="remove_user_btn">Remove User&emsp;<i class="fa fa-caret-right"></i></a>
                            </div>
                        </div>
